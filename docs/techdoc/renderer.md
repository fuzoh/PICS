...
* **PicsDetails** Display a big overview of the picture
  * **PicsMetas** Display fields to edit picture metadatas *This component interact with the main process via ipc. Event sender : **editPicsDatas**. Events listener : **picsDetailsUpdated**.*
